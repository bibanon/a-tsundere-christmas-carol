...
init -1 python hide:
    config.default_text_cps = 500
    config.developer = False
    config.screen_width = 1280                  
    config.screen_height = 720
    config.window_title = u"A Tsundere Carol"
    config.name = "A Tsundere Carol"
    config.version = "1.0"
    ...
    style.window.background = "box.png"

    ## Margin is space surrounding the window, where the background
    ## is not drawn.

    #style.window.xmargin = 100
    ...
    style.default.outlines=[(1, "#4A4A4A", 0, 0), (2, "#4A4A4A", 0, 0)]
    ...
    config.main_menu_music = "veryxmas.mp3"
...
python early:
    config.save_directory = "A Tsundere Carol-1418141354"
...
init python:
    ...
    build.directory_name = "A-Tsundere-Carol-1.0"

    ## The name that's uses for executables - the program that users will run
    ## to start the game. For example, if this is 'mygame', then on Windows,
    ## users can click 'mygame.exe' to start the game.
    build.executable_name = "A Tsundere Carol"
